            ...
            <div class="container">
                ...
                <div class="row featured__filter">
                    ...
                    <%
                        if (search_value != null) {
                            for (Product p : products) {
                                ...
                                if (p.getProductName().toLowerCase().contains(search_value.toLowerCase()) && p.getCategoryID()==category.getCategoryID()) {
                    %>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 mix c<%= p.getCategoryID()%>">
                            <div class="featured__item">
                                ...
                                <div class="featured__item__text">
                                    ...
                                    <h5>$<%= p.getPrice()%></h5><h4><%=category.getPrice()%></h4>
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    <%
                        ...
                        for (Product p : products) {
                        for(Category category : categorys){
                         if(category.getCategoryID() == p.getCategoryID()){
                    %>
                    ...
                    <a href="./detail.jsp?productID=<%= p.getProductID()%>">
                        <div class="col-lg-3 col-md-4 col-sm-6 mix c<%= p.getCategoryID()%>">
                            <div class="featured__item">
                                ...
                                <div class="featured__item__text">
                                    <h6><a href="./detail.jsp?productID=<%= p.getProductID()%>"><%= p.getProductName()%></a></h6>
                                    <h5>$<%= p.getPrice()%></h5><h6>Phí vận chuyển : $<%=category.getPrice() %></h6>
                                </div>
                            </div>
                        </div>
                    </a>
        ...
        <div class="banner">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="banner__pic">
                            <img src="img/banner/banner-2.png" alt="" width="90%">
                        </div>
                    </div>
                </div>
            </div>
