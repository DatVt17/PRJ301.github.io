                                ...
                                <tbody>
                                    ...
                                    <%
                                        for (OrderDetail detail : cartDetail) {
                                            ...
                                            Category category = DAO.CategoryDAO.getCategory(p.getCategoryID());
                                ...
                                <form action="updateCartServlet" method="POST">
                                    <tr>
                                        ...
                                        <td class="shoping__cart__total">
                                            ...
                                            <%  shipPrice += category.getPrice();
                                                subPrice += p.getPrice() * detail.getQuantity();
                                                totalPrice += (p.getPrice() * detail.getQuantity()) + category.getPrice(); ;
                                            %>
                                        </td>
                    ...
                    <div class="col-lg-6">
                        <div class="shoping__checkout">
                            ...
                            <ul>
                                ...
                                <li>Ship total <span>$<%=shipPrice %></span></li>
